...
VIEW_COLUMN_MAP: dict[str, dict[str, list[str]]] = {
    "vig.mvw_familia": {
        ...
        "bairro": ["raw.geo__tbl_geo.bairro via cep_norm"],
        "endereco": ["raw.geo__tbl_geo.endereco via cep_norm"],
        "cep": ["d.num_cep_logradouro_fam"],
        "num_cras": ["raw.geo__tbl_geo.cras via cep_norm"],
        "nom_cras": ["derivado CRAS + num_cras"],
        "bairro_cadu": ["d.nom_localidade_fam"],
        "endereco_cadu": ["d.nom_logradouro_fam", "d.nom_tip_logradouro_fam"],
        "num_cras_cadu": ["d.cod_unidade_territorial_fam"],
        "nom_cras_cadu": ["d.nom_unidade_territorial_fam"],
        "tem_geo": ["match cep × geo"],
        "lat_num": ["raw.geo__tbl_geo.lat_num"],
        "long_num": ["raw.geo__tbl_geo.long_num"],
    ...
    "vig.mvw_pessoas": {
        ...
        "ind_def_fisica": ["p.ind_def_fisica_memb"],
        "ind_def_cegueira": ["p.ind_def_cegueira_memb"],
        "ind_def_baixa_visao": ["p.ind_def_baixa_visao_memb"],
        "ind_def_surdez_profunda": ["p.ind_def_surdez_profunda_memb"],
        "ind_def_surdez_leve": ["p.ind_def_surdez_leve_memb"],
        "ind_def_mental": ["p.ind_def_mental_memb"],
        "ind_def_sindrome_down": ["p.ind_def_sindrome_down_memb"],
        "ind_def_transtorno_mental": ["p.ind_def_transtorno_mental_memb"],
