...
from ..vigilance.cras_analytics import (
    bairros_por_cras_from_views,
    cras_catalog_from_views,
    cras_catalog_lite_from_views,
    cras_painel_from_views,
)
...
def get_cras_catalog(
    ...
    try:
        with db.bind.connect() as conn:
            items = cras_catalog_lite_from_views(conn) if lite else cras_catalog_from_views(conn)
